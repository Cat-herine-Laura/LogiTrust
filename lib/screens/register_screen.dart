      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            Column(
              children: [
                Image.asset(darkTheme? 'images/locate.jpeg' : 'images/locate.jpeg'),
                        ...
                        child: Column(
                            ...
                            children: [
                              TextFormField(
                                ...
                                validator: (text){
                                  ...
                                  if (text.length >49){
                                    return "Name cant be more than 50";
                                  }
                                  return null;
                                },
                          ...
                          const SizedBox(height: 10,),
                                ...
                                validator: (text){
                                  ...
                                  if (text.length >99){
                                    return "Email cant be more than 100";
                                  }
                                  return null;
                                },
                                onChanged: (text) => setState(() {
                            ...
                            onChanged: (text) => setState(() {
                              ...
                              TextFormField(
                                ...
                                validator: (text){
                                  ...
                                  if (text.length >99){
                                    return "ADRESS cant be more than 100";
                                  }
                                  return null;
                                },
                                onChanged: (text) => setState(() {
                              ...
                              TextFormField(
                                ...
                                validator: (text){
                                  ...
                                  if (text.length >99){
                                    return "Password cant be more than 100";
                                  }
                                  return null;
                                },
                                onChanged: (text) => setState(() {
